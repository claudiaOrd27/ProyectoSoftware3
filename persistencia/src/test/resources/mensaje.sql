...
insert into mensajes(cod_mensaje,emisor,fecha_mensaje,mensaje,chat_usuario_cod_chat) values(1,"Karla","2022/6/25","tengo una duda sobre el producto",2);
insert into mensajes(cod_mensaje,emisor,fecha_mensaje,mensaje,chat_usuario_cod_chat) values(2,"Mario","2022/5/27","cuando llega el producto",1);
insert into mensajes(cod_mensaje,emisor,fecha_mensaje,mensaje,chat_usuario_cod_chat) values(3,"Juan","2022/2/12","falta mucho ara que llehue?",3);